                ...
                <div className="box">
                    ...
                    <form className="row g-3 mt-4" onSubmit={handleEditData}>
                        ...
                        <div className="col-6">
                            ...
                            <input type="text" className="form-control" id="pname" name='pname' value={editData.pname} onChange={handleForm} placeholder="Name" />
                        </div>
                        <div className="col-md-6">
                            <label htmlFor="inputEmail4" className="form-label">Email</label>
                            <input type="email" className="form-control" id="inputEmail4" name='email' value={editData.email} onChange={handleForm} placeholder='Email' />
                        </div>
                        <div className="col-6">
                            <label htmlFor="contact" className="form-label">Contact</label>
                            <input type="number" className="form-control" id="contact" name='contact' value={editData.contact} onChange={handleForm} placeholder="Contact" />
                        </div>
                        <div className="col-6">
                            <label htmlFor="date" className="form-label">Date</label>
                            <input type="date" className="form-control" id="date" name='date' value={editData.date} onChange={handleForm} placeholder="Date" />
                        </div>
                        <div className="col-6">
                            <label htmlFor="time" className="form-label">Time</label>
                            <input type="time" className="form-control" id="time" name='time' value={editData.time} onChange={handleForm} placeholder="Time" />
                        </div>
                        <div className="col-6">
                            <label htmlFor="dname" className="form-label">Doctor Name</label>
                            <input type="text" className="form-control" id="dname" name='dname' value={editData.dname} onChange={handleForm} placeholder="Enter doctor name" />
                        </div>
                        <div className="col-6">
                            <label htmlFor="address" className="form-label">Address</label>
                            <textarea id="address" className="form-control" name='address' value={editData.address} onChange={handleForm} placeholder="1234 Main St"></textarea>
                        </div>
                        <div className="col-6">
                            <label htmlFor="symptoms" className="form-label">Symptoms</label>
                            <textarea id="symptoms" className="form-control" name='symptoms' value={editData.symptoms} onChange={handleForm} placeholder="Symptoms"></textarea>
                        </div>
