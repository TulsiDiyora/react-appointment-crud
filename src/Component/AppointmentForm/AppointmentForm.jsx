            ...
            <Container>
                ...
                <form className="row g-3 mt-4" onSubmit={handleSubmit}>
                    ...
                    <div className="col-6">
                        ...
                        <input type="text" className="form-control" id="dname" name='dname' value={formInput.dname} onChange={handleForm} placeholder="Enter doctor name" />
                    </div>
                    <div className="col-6">
                    ...
                    <div className="col-6">
                        ...
                        <textarea id="symptoms" className="form-control" name='symptoms' value={formInput.symptoms} onChange={handleForm} placeholder="Symptoms"></textarea>
                    </div>
